...
type ExternalVolumeSnapshot struct {
	state protoimpl.MessageState `protogen:"open.v1"`
	// volume_name is the template volume this was captured from, matching the
	// ExternalVolume of the same name on the source Actor. A restored volume
	// keeps the name and takes a new storage_volume_id, which is what lets the
	// attach and mount paths stay unaware of snapshots entirely.
	//
	// +k8s:required
	...
	// creation_time is when the storage system cut the snapshot. This is the
	// point in time the volume data is from, which is not the same as when the
	// Tag was created.
	//
	// +k8s:optional
...
func (x *ExternalVolumeSnapshot) GetVolumeName() string {
	if x != nil {
		return x.VolumeName
	}
	return ""
...
func (x *ExternalVolumeSnapshot) GetCreationTime() *timestamppb.Timestamp {
	if x != nil {
...
func (x *DeleteAtespaceRequest) GetOptions() *DeleteOptions {
	if x != nil {
		return x.Options
	}
	return nil
...
func (x *DeleteActorTemplateRequest) GetOptions() *DeleteOptions {
	if x != nil {
		return x.Options
	}
	return nil
...
func (x *DeleteActorRequest) GetOptions() *DeleteOptions {
	if x != nil {
		return x.Options
	}
	return nil
...
func (x *DeleteTagRequest) GetOptions() *DeleteOptions {
	if x != nil {
		return x.Options
	}
	return nil
...
const file_ateapi_proto_rawDesc = "" +
	...
	"\rcreation_time\x18\x06 \x01(\v2\x1a.google.protobuf.TimestampR\fcreationTime\"\xbd\x01\n" +
	...
	"\aoptions\x18\x02 \x01(\v2\x15.ateapi.DeleteOptionsR\aoptions\"Z\n" +
	...
	"\x13DeleteActorTemplate\x12\".ateapi.DeleteActorTemplateRequest\x1a\x15.ateapi.ActorTemplate\"\x002\xdb\x01\n" +
	"\rWorkerService\x12X\n" +
